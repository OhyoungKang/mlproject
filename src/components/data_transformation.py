# mlproject/src/components/data_transformation.py
import os
import sys
...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[
                ("imputer",SimpleImputer(strategy="most_frequent")),  # handling missing values with most frequent category
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            transformed_input_test_feature=preprocessing_obj.fit_transform(input_feature_test_df)
